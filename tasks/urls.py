...
from .views import TaskDeleteView, TaskListView,TaskDetailView,TaskCreateView,TaskUpdateView,CommentCreateView,CommentDeleteView,CommentUpdateView,CommentListView
urlpatterns = [
